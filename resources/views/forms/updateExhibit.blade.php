        ...
        <div class="cards-table">
            ...
            <label for="art-{{$art['id']}}">
                <div class="card hover">
                    <div class="title">
                        <input style="float:left; " id="art-{{$art['id']}}" name="art[]" type="checkbox" value="{{$art['id']}}">
                        {{$art['title']}}
                    </div>
        ...
        <div class="cards-table">
            ...
            <label for="poetry-{{$poetry['id']}}">
                <div class="poetry-card hover">
                    <div class="title">
                        <input style="float:left;" id="poetry-{{$poetry['id']}}" name="poetry[]"type="checkbox" value="{{$poetry['id']}}">
                        "{{$poetry['title']}}"
                    </div>
